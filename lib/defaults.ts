...
export const EMPTY_INVITATION: Omit<CreateInvitationInput, "brideName" | "groomName"> = {
  ...
  duaText: "",
  religiousSource: "",
  islamicQuoteArabic: "وَمِنْ آيَاتِهِ أَنْ خَلَقَ لَكُم مِّنْ أَنفُسِكُمْ أَزْوَاجًا لِّتَسْكُنُوا إِلَيْهَا وَجَعَلَ بَيْنَكُم مَّوَدَّةً وَرَحْمَةً",
  islamicQuoteTurkish: "O'nun ayetlerinden biri de, size kendinizden eşler yaratması, onlara karşı huzur bulmanız ve aranızda sevgi ve merhamet var etmesidir.",
  islamicQuoteSource: "Rum Suresi, 21. Ayet",
